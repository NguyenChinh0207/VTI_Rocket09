...
VALUES 					(N'Nguyễn Thị Chinh'	, 'nchinh407@gmail.com'	, 1),
                        ...
                        (N'Nguyễn Thị Kim'		, 'kit9654@gmail.com'	, 5),
						(N'Là Thị Thúy'			, 'htthgfy44@gmail.com'	, 5),
						(N'Phúc Thúy Nga'		, 'kuuuu77@gmail.com'	, 5),
                        (N'Đỗ Anh Tú'			, 'va5656@gmail.com'	, 5),
						(N'Đỗ Long'				, 'dhlo7@gmail.com'		, 5),
						(N'Đào Thùy Chi'		, 'kgfg843@gmail.com'	, 5),
						(N'Hà Thu'				, 'dhf57@gmail.com'		, 5),
						(N'Quý Linh Ly'			, 'k6g843@gmail.com'	, 5);
...
CREATE OR REPLACE VIEW locationtk AS
    SELECT 
       l.location_id, count(e.employee_id) AS 'Số nhân viên đang làm việc theo tên nước'
    FROM location l
    LEFT JOIN employee e ON l.location_id = e.location_id
...
BEGIN
    ...
    INNER JOIN country c ON l.country_id = c.country_id) WHERE e.employee_id = NEW.employee_id GROUP BY c.country_id) >=10
...
INSERT INTO Employee(full_name				, email					, location_id)
VALUE 				(N'Hoàng Thị Chi'		,'hchi099@gmail.com'    , 3			);
